...
namespace EMX.HierarchyPlugin.Editor.Mods
{
	...
	public class CategoriesColorsWindowOld : Windows.IWindow
	{
		...
		internal static CategoriesColorsWindowOld Init(MousePos rect, Window adapter, BookProject.BookmarksforProjectviewModInstance _bm_inst, int scene)
		{ //  Debug.Log("ASD");
		...
		internal static CategoriesColorsWindowOld Init(MousePos rect, Window adapter, BookObject.BookmarksforGameObjectsModInstance _bm_inst, Scene scene)
		{ //  Debug.Log("ASD");
		  // if (adapter.GET_SKIN() == null) adapter.GET_SKIN() = Adapter.GET_SKIN();
