...
namespace EMX.HierarchyPlugin.Editor.Windows
{
	...
	public class IWindow : EditorWindow
	{
		...
		{
#if UNITY_2018_3_OR_NEWER
			if (!(this is InputWindow || this is Root_HighlighterWindowInterface || this is SearchWindow)) return;
			EditorApplication.quitting -= _apquite;
			EditorApplication.quitting += _apquite;
			inst_t = this;
#endif
		...
		internal static IWindow private_Init(MousePos inrect, Type type, Window a, string title = "", Vector2? minSize = null, Vector2? maxSize = null, bool utils = false,
